...
from pyTona.answer_funcs import feet_to_miles, hal_20, get_git_branch, get_git_url, get_other_users, get_fibonacci_seq, get_number_seq
...
class Interface(object):
    def __init__(self):
        ...
        self.question_answers = {
            ...
            'What is the number': QA('What is the number', get_number_seq)
        }
